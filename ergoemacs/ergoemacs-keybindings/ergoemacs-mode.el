...
(defun ergoemacs-ido-minibuffer-setup-hook ()
  ...
  (define-key ergoemacs-ido-keymap (kbd "C-@") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-a") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-c") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-f") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-j") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-k") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-l") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-o") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-p") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-t") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-w") nil)
  (define-key ergoemacs-ido-keymap (kbd "C-z") nil)
  (define-key ergoemacs-ido-keymap (kbd "M-m") nil)
  (define-key ergoemacs-ido-keymap (kbd "M-n") nil)
  (define-key ergoemacs-ido-keymap (kbd "M-o") nil)
  (define-key ergoemacs-ido-keymap (kbd "M-p") nil)
  (define-key ergoemacs-ido-keymap (kbd "M-s") nil)
